...
Pet::Pet()
{
    ...
    {
        m_state_machine.registerState("start", new PetStartState(this));
        m_state_machine.registerState("interact", new PetInteractState(this));
        m_state_machine.registerState("carry", new PetCarryState(this));
        m_state_machine.registerState("fall", new PetFallState(this));
        m_state_machine.registerState("idle", new PetIdleState(this));
        m_state_machine.registerState("move", new PetMoveState(this));
        m_state_machine.registerState("sit", new PetSitState(this));
        m_state_machine.registerState("sleep", new PetSleepState(this));
        m_state_machine.registerState("relax", new PetRelaxState(this));
        m_state_machine.registerState("skill_2_begin", new PetSkill2BeginState(this));
        m_state_machine.registerState("skill_2_loop", new PetSkill2LoopState(this));
