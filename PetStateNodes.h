...
{
public:
    PetSkill2BeginState(void* character);
...
{
public:
    PetSkill2LoopState(void* character);
...
{
public:
    PetInteractState(void* character);
